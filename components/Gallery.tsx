      ...
      <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 xl:gap-8">
          ...
          <a href="#"
            ...
            <span
              className="inline-block text-gray-200 text-xs md:text-sm border border-gray-500 rounded-lg backdrop-blur relative px-2 md:px-3 py-1 mr-3 mb-3">VR</span>
          </a>
          ...
          <a href="#"
            ...
            <span
              className="inline-block text-gray-200 text-xs md:text-sm border border-gray-500 rounded-lg backdrop-blur relative px-2 md:px-3 py-1 mr-3 mb-3">Retro</span>
          </a>
          ...
          <a href="#"
            ...
            <span
              className="inline-block text-gray-200 text-xs md:text-sm border border-gray-500 rounded-lg backdrop-blur relative px-2 md:px-3 py-1 mr-3 mb-3">Tech</span>
          </a>
